...
export default function LoginTemplate(){
    ...
    function handleLogin(e){
        ...
        {
            e.preventDefault();
            axios.post("http://localhost:5000/login", { username: loginUsername, password: loginPw })
    ...
    function handleRegister(e){
        ...
        if(registerEmail.length === 0 || pwIsInvalid || confirmPwInvalid){
            ...
            axios.post("http://localhost:5000/register", { username: registerUsername, email: registerEmail, password: loginPw })
                .then(res => { console.log(res) })
                .catch(error => { console.log(error) });
            setRegisterEmail("");
            setRegisterPw("");
